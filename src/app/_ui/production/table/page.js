...
export default function Table({ data }) {
  ...
  const handleCategoryFilterChange = (reactor) => {
    setCategoryFilter(reactor);
    setAnchorEl(null);
  };
    ...
    <div className={styles.tableContainer}>
      <div className={styles.filterSection}>
        ...
        <div className={styles.filterTab}>
          ...
          >
            {categoryFilter || "All Productions"}
          </Button>
          <Menu
            anchorEl={anchorEl}
          ...
          >
            ...
            {Array.from(new Set(data.map((item) => item.reactor))).map(
              (reactor) => (
                <MenuItem
                  key={reactor}
                  onClick={() => handleCategoryFilterChange(reactor)}
                >
                  {reactor}
                </MenuItem>
              )
